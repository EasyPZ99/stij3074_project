...
<body>
    ...
    <nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left" style="display:none;z-index:2;width:20%;min-width:200px" id="mySidebar">
        ...
        <a href="indexadmin.php" onclick="w3_close()" class="w3-bar-item w3-button">Manage Product</a>
        ...
        <div class="w3-grid-template">
             ...
             $cart = "cart";
                foreach ($rows as $items){
                    ...
                    <div class='w3-padding-small'><a href='item_details.php?item_id=$itemid'><img class='w3-container w3-image' 
                    ...
                    <input type='button' class='w3-button w3-blue w3-round' id='button_id' value='Add to Cart' onClick='addCart($itemid);'><br><br>
                    </div></div>";
                    //<a href='index.php?itemid=$itemid&submit=$cart' class='w3-btn w3-blue w3-round'>Add to Cart</a><br><br>
                }
             ?>
        </div>
    </div>
