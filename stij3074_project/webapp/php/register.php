...
if (isset($_POST['submit'])) {
    ...
    echo $sqlregister = "INSERT INTO `tbl_users`(`user_email`, `user_password`, `user_otp`, `user_name`) VALUES ('$email','$password','$otp','$name')";
    try {
...
function sendMail($email,$otp){
    ...
    <p><button><a href ='https://crimsonwebs.com/s271843/stij3074_project/webapp/php/verifyaccount.php?email=$email&otp=$otp'>Verify Here</a></button>";
