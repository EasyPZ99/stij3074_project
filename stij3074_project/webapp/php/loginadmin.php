...
if (isset($_POST["submit"])) {
  ...
  $otp = '1';
  $stmt = $conn->prepare("SELECT * FROM tbl_admin WHERE user_email = '$email' AND user_password = '$pass' AND user_otp='$otp'");
  $stmt->execute();
  ...
  if ($number_of_rows  > 0) {
      ...
      session_start();
      $_SESSION["sessionadmin"] = session_id();
...
function sendMail($email){
  ...
  <p><button><a href ='https://crimsonwebs.com/s271843/stij3074_project/webapp/php/verifyaccountadmin.php?email=$email'>Verify Here</a></button>";
      ...
      <div class="w3-row w3-card">
        ...
        <div class="w3-half w3-container">
          ...
          <form name="loginForm" class=""  action="loginadmin.php" method="post">
            ...
            <a href="#forgot.php" style="text-decoration:none;">Only for Admin Access.</a></p>
          </form>
        </div>
      </div>
    </div>
