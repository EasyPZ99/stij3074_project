        ...
        <div class="w3-grid-template">
             ...
             $total_payable = 0.00;
                foreach ($rowsqty as $items){
                    ...
                    $item_qty = $items['cart_qty'];
                    $item_total = $item_qty * $item_price;
                    $total_payable = $item_total + $total_payable;
                    echo "<div class='w3-center w3-padding-small' id='itemcard_$itemid'><div class = 'w3-card w3-round-large'>
                    <div class='w3-padding-small'><a href='item_details.php?itemid=$itemid'><img class='w3-container w3-image' 
                    src=../images/items/$item_isbn.jpg onerror=this.onerror=null;this.src='../images/items/default.jpg'></a></div>
                    <b>$item_title</b><br>RM $item_price/unit<br>
                    <input type='button' class='w3-button w3-red' id='button_id' value='-' onClick='removeCart($itemid,$item_price);'>
                    <label id='qtyid_$itemid'>$item_qty</label>
                    <input type='button' class='w3-button w3-green' id='button_id' value='+' onClick='addCart($itemid,$item_price);'>
                    <br>
                    <b><label id='itemprid_$itemid'> Price: RM $item_total</label></b><br></div></div>";
                }
             ?>
        </div>
        <?php 
